...
const SERVER_INSTRUCTIONS = [
  ...
  '- Icon PNGs must be exactly 128x128 (HC3 answers 400 INVALID_ICON_SIZE otherwise). Colour type does NOT matter; RGBA is fine.',
  '- Icon names (User<N>) are unique only WITHIN a bucket: the same name can be a room, scene and device icon at once, for three different images, and freed ids are reused. Never match an icon across buckets by name.',
